...
was built against, such as `deep-gemm==2.1.1+cu.12.8.torch.2.7`, and requires the
...
```console
$ uv add deep-gemm --index astral-cu128=https://wheels.astral.sh/simple/cu128/
```
...
```console
$ uv pip install --index https://wheels.astral.sh/simple/cu128/ deep-gemm
```
